defmodule Homework.Transactions.Transaction do
  ...
  def changeset(transaction, attrs) do
    transaction
    |> cast(attrs, [:user_id, :amount, :debit, :description, :merchant_id, :credit, :company_id])
    |> validate_required([:user_id, :amount, :debit, :description, :merchant_id, :credit, :company_id])
  end
end
